...
def fronteira_eficiente():
    ...
    start = form.date_input('Data de Início', value=pd.datetime(2018, 1, 1))
    end = form.date_input('Data Final')
    ticker_1 = form.text_input('TICKER - Yahoo Finance', value='FB')
    ticker_2 = form.text_input('TICKER - Yahoo Finance', value='F')
    ticker_3 = form.text_input('TICKER - Yahoo Finance', value='GE')
    ticker_4 = form.text_input('TICKER - Yahoo Finance', value='PYPL')
    ticker_5 = form.text_input('TICKER - Yahoo Finance', value='QCOM')
    ticker_6 = form.text_input('TICKER - Yahoo Finance', value='T')
    ...
    if submit:
        ...
        fig = go.Figure()
        fig.add_trace(go.Scatter(x=(mean_variance_pairs[:, 1] ** 0.5 * 100).round(1),
                                 y=(mean_variance_pairs[:, 0] * 100).round(1),
        ...
        fig.add_trace(go.Scatter(x=(mean_variance_pairs[:, 1] ** 0.5 * 100).round(1),
                                 ...
                                 mode='markers',
                                 text=[str(np.array(tickers_list[i])) + "<br>" + str(
                                     np.array(weights_list[i] * 100).round(0))
